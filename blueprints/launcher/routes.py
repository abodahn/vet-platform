...
MODULES = [
    ...
    },
    {
        ...
        "icon":        "📝",
        "description": "In-platform visit workflow · SOAP notes · Diagnoses · Prescriptions · Visit invoice",
        "url_key":     "visits.visits_list",
        "url":         "/visits/",
        "legacy":      False,
        "roles":       ["super_admin","clinic_owner","branch_manager","doctor","nurse","reception"],
        "status":      "active",
    ...
    },
    {
        ...
        "icon":        "🩻",
        "description": "X-ray & ultrasound studies · Upload · AI analysis · Per-pet study history",
        "url_key":     "imaging.index",
        "url":         "/imaging/",
        "legacy":      False,
        "roles":       ["super_admin","clinic_owner","branch_manager","doctor","nurse"],
        "status":      "active",
    ...
    {
        "id":          "inpatient",
        "name":        "Inpatient & Hospitalisation",
        "name_ar":     "القسم الداخلي والتنويم",
        "icon":        "🏥",
        "description": "Admissions · Wards & cages · Nursing rounds · Inpatient medication · Discharge",
        "url_key":     "inpatient.dashboard",
        "url":         "/inpatient/",
        "legacy":      False,
        "roles":       ["super_admin","clinic_owner","branch_manager","doctor","nurse"],
        "status":      "active",
    ...
    },
    {
        ...
        "url":         "/cds/",
        "legacy":      False,
        "roles":       ["super_admin","clinic_owner","branch_manager","doctor","nurse","pharmacist"],
        "status":      "beta",
        "category":    "clinical",
        "color":       "#0d9488",
        "badge":       "Beta",
    },
    {
        "id":          "telemedicine",
        "name":        "Telemedicine",
        "name_ar":     "الطب عن بُعد",
        "icon":        "📹",
        "description": "Video consultations · Session scheduling · Shareable room links · Invoice on completion",
        "url_key":     "telemedicine.dashboard",
        "url":         "/telemedicine/",
        "legacy":      False,
        "roles":       ["super_admin","clinic_owner","branch_manager","doctor","nurse","reception"],
        "status":      "active",
    ...
    },
    {
        ...
        "icon":        "💵",
        "description": "Monthly payroll runs · Salary components · Deductions · Payslips · Approval & payment",
        "url_key":     "payroll.dashboard",
        "url":         "/payroll/",
        "legacy":      False,
        "roles":       ["super_admin","clinic_owner","branch_manager","hr","finance"],
        "status":      "active",
        "category":    "admin",
        "color":       "#166534",
        "badge":       "Live",
